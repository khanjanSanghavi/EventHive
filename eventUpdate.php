    ...
    if($error === 0){
        if($img_size > 125000){
            ...
            if(move_uploaded_file($tmp_name, $target_file)) {
                ...
                $r = $obj->event_update($eventid,$eventName,$organizerName,$date,$time,$venue,$Description,$cost,$target_file,$s_id);
    ...
    <div class="form-container">
        ...
        <form  method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input class="form-control" type="file" name="eImage" id="eventImage" value = "<?php echo $r['Image']?>">
            </div>
